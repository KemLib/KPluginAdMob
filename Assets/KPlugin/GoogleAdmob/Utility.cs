...
namespace KPlugin.GoogleAdMob
{
    public static class Utility
    {
        ...
        public static Vector2 Unity_GetSize(AdSize adSize)
        {
            Vector2 sizeAdMob = AdMob_GetSize(adSize);
            return Convert_AdMobToUnity(sizeAdMob);
        }
        public static Vector2 Unity_GetPosition(AdPosition adPosition, Vector2 bannerSize)
        {
            Vector2 positionAdMob = AdMob_GetPosition(adPosition, Convert_UnityToAdMob(bannerSize));
        ...
        public static Vector2 AdMob_GetSize(AdSize adSize)
        {
            switch (adSize)
            {
                case AdSize.Standard:
        ...
        public static Vector2 AdMob_GetPosition(AdPosition adPosition, Vector2 bannerSize)
        {
            Vector2 screenSize = AdMob_GetScreen();
            switch (adPosition)
            {
