...
namespace KPlugin.AdMob.Editor
{
    public class GoogleAdMobSettingEditor
    {
        ...
        private SerializedProperty propertyAdMobAndroidAppId,
            ...
            propertyDisableOptimizeInitialization,
            propertyDisableOptimizeAdLoading,
        ...
        private void OnGUI_PropertyGoogleAdMob()
        {
            ...
            EditorGUILayout.PropertyField(propertyDisableOptimizeInitialization, new GUIContent("Disable Optimize Initialization"));
            EditorGUILayout.PropertyField(propertyDisableOptimizeAdLoading, new GUIContent("Disable Optimize Ad Loading"));
        ...
        private void SettingObject_Load()
        {
            ...
            if (scriptable == null)
            {
                ...
                propertyDisableOptimizeInitialization = null;
                propertyDisableOptimizeAdLoading = null;
            ...
            propertyDisableOptimizeInitialization = serializedGoogleAdMob.FindProperty("disableOptimizeInitialization");
            propertyDisableOptimizeAdLoading = serializedGoogleAdMob.FindProperty("disableOptimizeAdLoading");
